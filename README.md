...
- [x] Групповые чаты
- [x] WebSocket и real-time сообщения
- [x] Управление сообщениями (редактирование, удаление)
- [x] Загрузка аватарок пользователей и групп
- [x] Прикрепление файлов к сообщениям
- [x] Docker для деплоя
